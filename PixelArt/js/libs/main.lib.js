...
function resize() {
    ...
    if (winH == undefined || winW == undefined) {
        ...
        var css = function(len) {
            ...
            var fCurrNumW = Math.trunc(window.innerHeight * .072 * 3.2)
            doc('fCurrNum').querySelector('div.counter').style.width = fCurrNumW
            doc('fCurrNum').style.margin = window.innerHeight * .024 + 'px 0'
            doc('fCurrNum').style.lineHeight = window.innerHeight * .072 + 'px'
            doc('fCurrNum').style.fontSize = window.innerHeight * .04 + 'px'
